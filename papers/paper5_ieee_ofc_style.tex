...
Our contribution is not the decomposition technique itself, but its
\emph{application to a real, production-scale medical vision-language model}
(MedGemma-4B-IT~\cite{medgemma2025}), with a complete rank sweep, honest
error reporting, and an explicit deployment context in low-resource healthcare.
